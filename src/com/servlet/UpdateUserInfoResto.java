...
public class UpdateUserInfoResto extends HttpServlet {
...
private static final long serialVersionUID = 1L;
    ...
    public void doPost(   HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
    	...
    	Resto_Account user = new Resto_Account();
		...
		String message=this.userDao.update_user_resto(phone, courriel, lid);
		user= (Resto_Account) session.getAttribute("objet");
		user.setPhone(phone);
